<section class="panel">
    ...
    <figure>
        <h1>Colegiaturas</h1>
        <img src="../assets/svg/Deadline (1).svg" alt="">
    </figure>
</section>
<section id="option-action" class="panel2">
    <div class="main">
        <div class="up">
            <button onclick="window.location.href='colegiaturas-crud/pay-add.html'" class="card1">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" width="21" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
        ...
        <div class="down">
            <button class="card3">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
...
<script>
    ...
    document.getElementById("back-btn").addEventListener("click", () => btn_menu());
</script>